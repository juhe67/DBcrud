...
public class ItemEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (item != null) {
            ...
            btnsumbit.setOnClickListener(view -> updateItem(item));
        } else {
            btnsumbit.setOnClickListener(view -> addItem());
        }
    }
    ...
    private void updateItem(Item item) {
        ...
        FirebaseUtils.getReference(FirebaseUtils.ITEMS_PATH).child(item.getKey()).setValue(item).addOnSuccessListener(this, unused -> {
